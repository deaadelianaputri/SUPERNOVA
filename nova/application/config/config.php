...
|
*/
$config['base_url'] = 'http://localhost/super/nova';
...
$config['sess_expiration'] = 7200; // Waktu session dalam detik
$config['sess_save_path'] = NULL; // Biarkan NULL jika menggunakan default
